...
public class DetectCycleWithNegativeWeight {
    ...
    public boolean bellmanFordAlgorithm(int sourceVertex, int V, ArrayList<ArrayList<int[]>> adjList){
        ...
        // Step - 3
        // To report if there is a negative weight cycle in graph
        // Try to relax all the edges again
        // The idea of step 3 is, step 2 guarantees the shortest distances iff the graph doesn't contain
        // a negative weight cycle. If we iterate through all edges one more time and get a shorter
